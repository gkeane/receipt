...
<head>
  ...
  <link rel="stylesheet" href="signature-pad/jquery.signaturepad.css">
...
<body>
  ...
  ?>
  <script src="signature-pad/jquery.signaturepad.min.js"></script>
  <?php
  ...
  <?php endif; ?>
  <script src="signature-pad/json2.min.js"></script>
</body>
